...
class Controller:
	...
	def __init__(self, width=1280, height=720):
		...
		pygame.mixer.music.load("../FinalProject/assets/song.mp3")
		...
		self.player2 = character.Character("Demon Slayer", width-318, height-370, "Left")
	...
	def instructionMenu(self):
		...
		instruction2 = self.drawFont("            f / g / h / j --- punch / kick / block / ultimate",200,150)
		instruction3 = self.drawFont("Player2  :  leftarrow / rightarrow --- move left / move right",200,250)
		instruction4 = self.drawFont("            4 / 5 / 6 / 7 --- punch / kick / block / ultimate",200, 350)
		instruction5 = self.drawFont("Hitting opponents fills your SP bar. At max SP, use your ultimate!", 100, 450)
	...
	#'''This is the Main Loop of the Game'''
		...
		while self.gameOn == True:
			...
			pygame.draw.rect(self.screen, (160,32,240), [10,60,4*self.player1.energyRate,50])  #energy bar
			pygame.draw.rect(self.screen, (160,32,240), [1270-4*self.player2.energyRate,60, 4*self.player2.energyRate,50])
			...
			if self.gameOver == True:
				...
				if (self.KO.update() == 1):
					if(self.gameOver == True):
						self.screen.blit(self.background, (0, 00))
						self.screen.blit(self.backgroundImage.image, self.backgroundImage.rect)
