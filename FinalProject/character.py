...
class Character(pygame.sprite.Sprite):
	...
	def fight(self, fight, opponent):
		...
		if(self.invincibility == False):
			...
			if(fight == "punch" and opponent.health > 0 and pygame.sprite.collide_rect(self, opponent) and (opponent.invincibility == False or self.facing == opponent.facing)):              
				self.hit(opponent, 10, 30)
		if(self.invincibility == False):
			#Run the kick animation even without collision
			# because its a human right
			if (self.facing == "Right"):
